About sphinx-gallery-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/sphinx-gallery-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sphinx-gallery-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add sphinx-gallery
# for installing globally
pixi global install sphinx-gallery
```
...
It is possible to list all of the versions of `sphinx-gallery` available on your platform:
...
```
pixi search sphinx-gallery --channel conda-forge
```
